            ...
            <div class="row mb-5">
                <div class="container">
                    <div class="col">
                                ...
                                <div class="btn btn-1">
                                    <a href="{{route('physical.add')}}" class="btn btn-info">Physical Abuse</a>
                                </div> <br/>
                                 <div class="btn btn-2">
                                    <a href="{{route('domestics.add')}}" class="btn btn-info">Domestic Violence or Abuse</a>
                                </div> <br/>  
                                 <div class="btn btn-4">
                                  <a href="{{route('psychological.add')}}" class="btn btn-info">Psychological or Emotional Abuse</a>
                                </div> <br/>
                                 <div class="btn btn-5">
                                    <a href="{{route('discriminatorys.add')}}" class="btn btn-info">Discriminatory Abuse</a>
                                </div> <br/>
                                 <div class="btn btn-6">
                                    <a href="{{route('organisational.add')}}" class="btn btn-info">Organisational or Institutional Abuse</a>
                                </div> <br/>
                                 <div class="btn btn-7">
                                    <a href="{{route('neglects.add')}}" class="btn btn-info">Neglect or Acts of Omission</a>
                                </div> <br/>
                </div>
         </div>
    </section>
