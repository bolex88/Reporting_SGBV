...
body {
  background-image: url("img/be-the-voice.jpg");
   min-height: 380px;
...
<form id="regForm" action="{{route('abuses.save')}}" method="post">
  ...
  <div class="tab"><h2>Types of Sexual abuse:</h2> <br />
                            <tr>
                                <h5>
  ...
  <div class="tab"><h2>Possible indicator of Sexual abuse:</h2> <br />
   <tr>
                                <h5>
  ...
  <div class="tab"><h2>Child identification details</h2>:
      ...
      <p><input type="date" placeholder="Date of birth" oninput="this.className = ''" name="Birthdate"></p>
