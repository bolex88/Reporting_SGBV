...
body {
  background-image: url("img/kids-we-can.jpg");
  min-height: 380px;
...
<form id="regForm" action="{{route('abuses.save')}}" method="post">
  ...
  <div class="tab"><h2>Types of Domestic violence or abuse:</h2> <br />
                            <tr>
                                <h5>
  ...
  <div class="tab"><h2>Possible indicator of Domestic violence or abuse:</h2> <br />
                            <tr>
                                <h5>
