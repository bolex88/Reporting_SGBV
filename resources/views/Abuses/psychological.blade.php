...
body {
  background-image: url("img/CAP-Month_Organic.jpg");
   min-height: 380px;
...
<form id="regForm" action="{{route('abuses.save')}}" method="post">
  ...
  <div class="tab"><h2>Types of Psychological or emotional abuse:</h2><br />
                            <tr>
                                <h5>
  ...
  <div class="tab"><h2>Possible indicator of Psychological or emotional abuse:</h2><br/>
                            <tr>
                                <h5>
