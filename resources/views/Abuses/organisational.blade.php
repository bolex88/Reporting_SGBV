...
<head>
    ...
    <title>Organisational or Instutional Abuse</title>
...
body {
  background-image: url("img/Snip20170315_8.png");
  min-height: 380px;
...
<form id="regForm" action="{{route('abuses.save')}}" method="post">
  ...
  <div class="tab"><h2>Types of Organisational or instutional abuse:</h2><br />
                            <tr>
                                <h5>
  ...
  <div class="tab"><h2>Possible indicator of Organisational or Instutional abuse:</h2><br />
                            <tr>
                                <h5>
