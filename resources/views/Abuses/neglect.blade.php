...
<head>
    ...
    <title>Neglect and acts of Omission</title>
...
body {
  background-image: url("img/CHILD-ABUSE-BANNER.png");
  min-height: 380px;
...
<form id="regForm" action="{{route('abuses.save')}}" method="post">
  ...
  <div class="tab"><h2>Types of Neglect or acts of omission:</h2> <br />
                            <tr>
                                <h5>
  ...
  <div class="tab"><h2>Possible indicator of Neglect or acts of omission:</h2> <br />
                            <tr>
                                <h5>
